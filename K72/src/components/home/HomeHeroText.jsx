  ...
  return (
    <div className="font-[font1] pt-5 text-center">
      ...
      <div className="text-[9.5vw] flex items-center justify-center uppercase leading-[8vw]">
        qui
        <div className="h-[7vw] rounded-full -mt-6 overflow-hidden ">
          <Video />
        </div>
        génère
      </div>
      <div className="text-[9.5vw] flex items-center justify-center uppercase leading-[8vw]">la créativité</div>
    </div>
  );
};
